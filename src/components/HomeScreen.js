...
const item_image1 = require('./src/asset/item_image_1.png');
const item_image2 = require('./src/asset/item_image_2.png');
const item_image3 = require('./src/asset/item_image_3.png');
const item_image4 = require('./src/asset/item_image_4.png');
      ...
      <View>
        ...
        <View style={styles.container}>
          ...
          <View style={styles.banner}>
            ...
            <Image
              source={require('./src/asset/section_banner.png')}
